...
from . import wall, myTank, enemyTank, food
...
def main():
    ...
    # 加载图片,音乐,音效.
    background_image     = pygame.image.load(r"other_games\tankwar\image\background.png")
    home_image           = pygame.image.load(r"other_games\tankwar\image\home.png")
    home_destroyed_image = pygame.image.load(r"other_games\tankwar\image\home_destroyed.png")
    
    bang_sound          = pygame.mixer.Sound(r"other_games\tankwar\music\bang.wav")
    # bang_sound.set_volume(1)
    fire_sound           = pygame.mixer.Sound(r"other_games\tankwar\music\Gunfire.wav")
    start_sound          = pygame.mixer.Sound(r"other_games\tankwar\music\start.wav")
    start_sound.play()
    ...
    # 敌军坦克出现动画
    appearance_image = pygame.image.load(r"other_games\tankwar\image\appear.png").convert_alpha()
    appearance = []
