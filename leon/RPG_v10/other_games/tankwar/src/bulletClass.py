...
class Bullet(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.bullet_up = pygame.image.load(r"other_games\tankwar\image\bullet_up.png")
        self.bullet_down = pygame.image.load(r"other_games\tankwar\image\bullet_down.png")
        self.bullet_left = pygame.image.load(r"other_games\tankwar\image\bullet_left.png")
        self.bullet_right = pygame.image.load(r"other_games\tankwar\image\bullet_right.png")
